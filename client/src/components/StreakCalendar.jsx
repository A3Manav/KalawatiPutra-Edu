...
const StreakCalendar = ({ streaks = [] }) => {
	...
	// Generate dates for current year (January 1 to December 31)
								...
								<div key={weekIndex} className="flex flex-col gap-1">
									{week.map((date, dayIndex) => {
										...
										return (
											<div
												key={dayIndex}
												className={`w-4 h-4 rounded-lg transition-all duration-300 hover:scale-125 hover:rotate-12 border relative group ${
													date === null
