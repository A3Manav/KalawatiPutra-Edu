                        ...
                        >
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full flex-grow bg-gray-800/50 border border-gray-700/50 text-white py-2 rounded-lg px-10 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600 transition-colors"
