	...
	useEffect(() => {
		...
		switch (sortBy) {
			case "price-low":
				...
				break;
			case "price-high":
				filtered = [...filtered].sort((a, b) => b.price - b.price);
				break;
			case "popular":
		...
		<div className="relative bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-gray-100">
			...
			<div className="container mx-auto px-4 py-6 lg:py-8">
				<div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
					...
					{/* Mobile Sidebar */}
					<aside
						className={`fixed left-0 top-0 h-full w-80 bg-gray-950/95 backdrop-blur-xl border-r border-gray-800/50 z-50 transform transition-transform duration-300 ease-in-out lg:hidden ${
						...
						{loading ? (
							<div className="flex justify-center items-center py-20">
								<div className="relative">
									...
									<div className="animate-ping absolute inset-0 rounded-full h-12 w-12 border border-emerald-500/30"></div>
								</div>
							</div>
						) : (
										...
										<div className="p-5">
											...
											<div className="flex justify-between items-center">
												...
												<button
													...
													className={`group/btn relative flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-300 transform hover:scale-110 ${
