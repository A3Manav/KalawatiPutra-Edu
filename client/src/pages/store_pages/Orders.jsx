...
import { Package, ChevronDown, Clock, CheckCircle, XCircle, Zap } from "lucide-react";
...
const Orders = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`${VITE_API_URL}/orders?page=${page}`, {
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className={`ml-2 font-medium ${
                          order.status.toLowerCase() === 'pending' ? 'text-yellow-400' :
